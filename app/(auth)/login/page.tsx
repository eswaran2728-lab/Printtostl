...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <p className="text-gray-400 text-sm mb-8">Sign in to continue creating 3D models</p>
      ...
      <button
        type="button"
        className="w-full bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium py-3 rounded-lg text-sm transition-all flex items-center justify-center gap-2"
        onClick={() => alert('Google OAuth — connect Supabase to enable')}
      >
